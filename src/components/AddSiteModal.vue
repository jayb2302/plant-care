  ...
  <div class="modal  " @click="closeModal">
    ...
    <div class="modal-content flex flex-col   " @click.stop>
      ...
      <div class="site-list w-4/4 lg:w-12/12 items-evenly flex  flex-row flex-wrap  ">
        ...
        <div class="site-card w-5/12 lg:w-2/12 p-1  flex lg:flex-col lg:m-1 " v-for="site in sites" :key="site.id"
          @click="selectSite(site)" :class="{ selected: site === selectedSite }">
        ...
        <div class="modal-content flex flex-col ">
          ...
          <div class="light-content py-5 flex items-center md:items-evenly flex-col ">
            <div class="flex  md:justify-evenly">
              <button class="light-btn flex flex-col items-center" @click="setLightCondition('Full-shade')"
                :class="{ selected: selectedButton === 'Full-shade' }">
                <img src="../components/icons/fullShade.svg" style="width: 60px; height: 60px;" alt="Full shade icons">
                Full-shade
              </button>
              <button class="light-btn flex flex-col items-center" @click="setLightCondition('Part-shade')"
                :class="{ selected: selectedButton === 'Part-shade' }">
            ...
            <div class="flex justify-center md:justify-evenly">
              <button class="light-btn flex flex-col items-center" @click="setLightCondition('Part-sun')"
                :class="{ selected: selectedButton === 'Part-sun' }">
                <img src="../components/icons/partSun.svg" style="width: 60px; height: 60px;" alt="Part sun icon">
                Part-sun
              </button>
              <button class="light-btn flex flex-col items-center" @click="setLightCondition('Full-sun')"
                :class="{ selected: selectedButton === 'Full-sun' }">
...
// Array of sample sites with names and thumbnails
const sites = ref([
...
// Function to handle the site selection and show the light condition modal
...
// Function to confirm the light condition selection
